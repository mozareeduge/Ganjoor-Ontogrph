...
- [ ] **U08 â€” packaging:** complete package metadata and dev dependency group; build wheel and sdist, then run a clean-wheel smoke test.
- [ ] **U09 â€” CI:** add Windows/Ubuntu Ã— Python 3.10/3.12 coverage and close Gate F from actual CI-equivalent commands.
